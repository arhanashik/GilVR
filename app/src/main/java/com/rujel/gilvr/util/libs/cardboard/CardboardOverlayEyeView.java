package com.rujel.gilvr.util.libs.cardboard;
 ...
 * *
 * * Purpose : A simple view group containing some horizontally centered text underneath a horizontally centered image.
 * *
 * * Last Edited by :
 * *
 * * Last Reviewed by :
